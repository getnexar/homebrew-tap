class Nexar < Formula
  ...
  homepage "https://github.com/getnexar/corp-load-balancer"
  version "1.0.0"
  license "MIT"

  on_macos do
    if Hardware::CPU.intel?
      url "https://github.com/getnexar/corp-load-balancer/releases/download/v1.0.0/nexar-darwin-amd64"
    ...
    if Hardware::CPU.arm?
      url "https://github.com/getnexar/corp-load-balancer/releases/download/v1.0.0/nexar-darwin-arm64"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/getnexar/corp-load-balancer/releases/download/v1.0.0/nexar-linux-amd64"
